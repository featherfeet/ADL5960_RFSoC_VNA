...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S07_AXIS_TDATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S06_AXIS_TDATA_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "C_S04_AXIS_TDATA_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_S05_AXIS_TDATA_WIDTH" -parent ${Page_0}
